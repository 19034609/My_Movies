...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Movie movie1 = new Movie("The Avengers", 2012, "pg13", "Action | Sci-Fi", watchDate, "Golden Village - Bishan", "Nick Fury of S.H.I.E.L.D. assembles a team of superheroes to save the planet from Loki and his army.", 4.0);
        alMovieList.add(movie1);

        watchDate.set(2015, 5-1, 15);
        Movie movie2 = new Movie("Planes", 2013, "pg", "Animation | Comedy", watchDate, "Cathay - AMK Hub", "A crop-dusting plane with a fear of heights lives his dream of competing in a famous around-the-world aerial race.", 2.0);
        alMovieList.add(movie2);

        watchDate.set(2015, 5-1, 15);
        Movie movie3 = new Movie("Sonic the Hedgehog", 2020, "pg", "Action | Adventure | Comedy", watchDate, "Cathay - Jurong Point", "A crop-dusting plane with a fear of heights lives his dream of competing in a famous around-the-world aerial race.", 3.0);
